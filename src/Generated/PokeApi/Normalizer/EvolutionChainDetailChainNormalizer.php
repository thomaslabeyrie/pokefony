...
class EvolutionChainDetailChainNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \App\Generated\PokeApi\Model\EvolutionChainDetailChain::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && \App\Generated\PokeApi\Model\EvolutionChainDetailChain::class === get_class($data);
    }
