...
class PaginatedContestTypeSummaryListNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \App\Generated\PokeApi\Model\PaginatedContestTypeSummaryList::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \App\Generated\PokeApi\Model\PaginatedContestTypeSummaryList::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \App\Generated\PokeApi\Model\PaginatedContestTypeSummaryList();
        ...
        if (\array_key_exists('results', $data)) {
            ...
            foreach ($data['results'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \App\Generated\PokeApi\Model\ContestTypeSummary::class, 'json', $context);
            }
    ...
    {
        return [\App\Generated\PokeApi\Model\PaginatedContestTypeSummaryList::class => false];
    }
}