...
class PaginatedRegionSummaryListNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \App\Generated\PokeApi\Model\PaginatedRegionSummaryList::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && \App\Generated\PokeApi\Model\PaginatedRegionSummaryList::class === get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \App\Generated\PokeApi\Model\PaginatedRegionSummaryList();
        ...
        if (\array_key_exists('results', $data)) {
            ...
            foreach ($data['results'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \App\Generated\PokeApi\Model\RegionSummary::class, 'json', $context);
            }
    ...
    {
        return [\App\Generated\PokeApi\Model\PaginatedRegionSummaryList::class => false];
    }
}
