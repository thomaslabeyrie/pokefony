...
class MachineDetailNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \App\Generated\PokeApi\Model\MachineDetail::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && \App\Generated\PokeApi\Model\MachineDetail::class === get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \App\Generated\PokeApi\Model\MachineDetail();
        ...
        if (\array_key_exists('move', $data)) {
            $object->setMove($this->denormalizer->denormalize($data['move'], \App\Generated\PokeApi\Model\MoveSummary::class, 'json', $context));
            unset($data['move']);
        }
    ...
    {
        return [\App\Generated\PokeApi\Model\MachineDetail::class => false];
    }
}
