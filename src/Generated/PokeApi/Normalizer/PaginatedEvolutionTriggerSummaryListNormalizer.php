...
class PaginatedEvolutionTriggerSummaryListNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \App\Generated\PokeApi\Model\PaginatedEvolutionTriggerSummaryList::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \App\Generated\PokeApi\Model\PaginatedEvolutionTriggerSummaryList::class;
    }
