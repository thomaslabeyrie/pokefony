...
class TypeDetailDamageRelationsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \App\Generated\PokeApi\Model\TypeDetailDamageRelations::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && \App\Generated\PokeApi\Model\TypeDetailDamageRelations::class === get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \App\Generated\PokeApi\Model\TypeDetailDamageRelations();
        ...
        if (\array_key_exists('no_damage_to', $data)) {
            ...
            foreach ($data['no_damage_to'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \App\Generated\PokeApi\Model\TypeDetailDamageRelationsNoDamageToItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('half_damage_to', $data)) {
            ...
            foreach ($data['half_damage_to'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \App\Generated\PokeApi\Model\TypeDetailDamageRelationsHalfDamageToItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('double_damage_to', $data)) {
            ...
            foreach ($data['double_damage_to'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, \App\Generated\PokeApi\Model\TypeDetailDamageRelationsDoubleDamageToItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('no_damage_from', $data)) {
            ...
            foreach ($data['no_damage_from'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, \App\Generated\PokeApi\Model\TypeDetailDamageRelationsNoDamageFromItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('half_damage_from', $data)) {
            ...
            foreach ($data['half_damage_from'] as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, \App\Generated\PokeApi\Model\TypeDetailDamageRelationsHalfDamageFromItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('double_damage_from', $data)) {
            ...
            foreach ($data['double_damage_from'] as $value_5) {
                $values_5[] = $this->denormalizer->denormalize($value_5, \App\Generated\PokeApi\Model\TypeDetailDamageRelationsDoubleDamageFromItem::class, 'json', $context);
            }
    ...
    {
        return [\App\Generated\PokeApi\Model\TypeDetailDamageRelations::class => false];
    }
}
