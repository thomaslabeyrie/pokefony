 ...
 */
final class Version20260224220927 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pokemon (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, pokemon_id INT NOT NULL, name VARCHAR(255) NOT NULL, types JSON NOT NULL, sprite_url VARCHAR(255) NOT NULL, PRIMARY KEY (id))');
